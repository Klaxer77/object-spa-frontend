...
export const ProgramsDesktop: React.FC = () => {
  ...
  return (
    <Element className="max-2xl:hidden" name="programs">
        ...
        <Container>
          <div className="mb-[30px]">
            ...
            <motion.p
              ...
              Индивидуальные продуманные программы перезагрузки и восстановления в роскошных Спа –пространствах с римской или русской парной.
          ...
          {/* Линия */}
          <motion.div
            className="absolute h-[1px] bg-white/15 max-sm:hidden"
            style={{
              top: '147px',
