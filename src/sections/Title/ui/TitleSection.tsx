  ...
  return (
    <section className="mt-[50px] relative z-[0] overflow-hidden max-lg:pt-[10px]">
      <motion.div
        ...
        initial="hidden"
        animate="visible"
        className="w-full h-[375px] bg-transparent border-t border-white/15 px-[10px] max-lg:hidden">
        <motion.div
          variants={fadeIn(0.2)}
          initial="hidden"
          animate="visible"
          ...
          <motion.div
            ...
            <motion.div
              ...
              <motion.div
                ...
                <motion.div className="w-full h-[375px] border-x border-white/15 px-[75px]">
                  <div className="w-full h-[375px] border-x border-white/15 flex flex-col justify-center items-center px-[35px] max-lg:border-none">
                    <motion.div
                      initial={{ opacity: 0 }}
                      animate={{ opacity: 1 }}
                      transition={{ duration: 0.5, delay: 0.1 }}
                      className="flex-col justify-center items-center w-full hidden max-2xl:flex">
                      <svg
                        className="mb-[32px]"
      ...
      <motion.div className='px-[15px] pt-[45px] hidden max-lg:block'>
        <motion.div
          ...
          animate={{ opacity: 1 }}
          transition={{ duration: 0.5, delay: 0.1 }}
          className="flex-col justify-center items-center w-full hidden max-2xl:flex border border-b-0 border-white/15 p-[35px]">
          <svg
            className="mb-[32px] max-sm:hidden"
            xmlns="http://www.w3.org/2000/svg"
            width={51}
            height={40}
            viewBox="0 0 51 40"
      ...
      <motion.div
        ...
        animate={{ opacity: 1 }}
        transition={{ duration: 0.5, delay: 0.1 }}
        className="absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 flex flex-col justify-center items-center w-full max-2xl:hidden">
        <svg
          className="mb-[32px]"
          xmlns="http://www.w3.org/2000/svg"
          width={51}
