export const Header: React.FC = () => {
  return (
    <header className="h-[60px] w-full flex items-center justify-between pl-[30px] border-b border-white/15">
      <div>
        <svg
          ...
          <mask
            ...
            width={139}
            height={17}>
            <rect y={0.00012207} width={138.119} height={16} fill="url(#pattern0_587_1617)" />
          </mask>
          <g mask="url(#mask0_587_1617)">
            <rect y={0.00012207} width={138.4} height={16} fill="#F4F4F4" />
          </g>
          <defs>
            <pattern
              id="pattern0_587_1617"
              patternContentUnits="objectBoundingBox"
              width={1}
              height={1}>
              <use xlinkHref="#image0_587_1617" transform="scale(0.000383583 0.00331126)" />
            </pattern>
            <image
              id="image0_587_1617"
              width={2607}
      ...
      <div className="flex">
        <button className="border-l border-white/15 font-[500] text-[14px] leading-[20px] h-[60px] w-[130px] flex justify-center items-center">
          Связаться
        </button>
        <button className="bg-white h-[60px] w-[180px] text-black text-[14px] font-[500] leading-[20px] uppercase flex justify-center items-center">
          Забронировать
        </button>
      </div>
    </header>
